...
let closet = new Item("closet", "dark but you can feel all the clothes and shoes")
let washroom = new Room("washroom", "all dirty and has a sink, stand up shower, and a toilet")
let sink = new Item("washroom sink", " full with a light red-ish water and a box cutter")
let shower = new Item("stand up shower", "")
...
guestroom.addItem(closet);
livingroom.addItem(washroom);
